...
UPDATE [$(gnsduser)].GNSD_JOBS
 SET CREATEDATE = (SELECT MIN(TIMESTAMP) FROM [$(gnsduser)].GNSD_JOBS_LOG WHERE [$(gnsduser)].GNSD_JOBS_LOG.JOBID = [$(gnsduser)].GNSD_JOBS.JOBID),
 STATEDATE = (SELECT MAX(TIMESTAMP) FROM [$(gnsduser)].GNSD_JOBS_LOG WHERE [$(gnsduser)].GNSD_JOBS_LOG.JOBID = [$(gnsduser)].GNSD_JOBS.JOBID);
