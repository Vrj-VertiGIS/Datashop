...
ALTER TABLE &&1..GNSD_JOBS
    ADD (MACHINENAME VARCHAR2(255) NULL,
    CUSTOM4 VARCHAR2(2000) NULL,
    CUSTOM5 VARCHAR2(2000) NULL,
    CUSTOM6 VARCHAR2(2000) NULL,
    CUSTOM7 VARCHAR2(2000) NULL,
    CUSTOM8 VARCHAR2(2000) NULL,
    CUSTOM9 VARCHAR2(2000) NULL,
    CUSTOM10 VARCHAR2(2000) NULL)
