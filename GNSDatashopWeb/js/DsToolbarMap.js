...
var mapToolbar = function (map, divMap) {
    ...
    this.GetActiveGraphic = function () {
        return activeGra;
    }
    ...
    this.HighlightGraphic = function(graphic) {
...
//        tbDraw.deactivate();
//        //host.DisableEdit();
//        tbNav.activate(esri.toolbars.Navigation.PAN);
//        //map.graphics.enableMouseEvents();
...
//        map.graphics.disableMouseEvents();
    ...
    this.CreateCircleGeometry = function (map, pt, radius) {
        ...
        for (var i = 0; i <= 360; i += 10) {
            ...
            points.push(new esri.geometry.Point(x, y, map.spatialReference));
        }
    ...
    this.CreateRectangleGeometry = function (map, extent) {
        ...
        var points = [];
        points.push(new esri.geometry.Point(extent.xmax, extent.ymax, map.spatialReference));
        points.push(new esri.geometry.Point(extent.xmax, extent.ymin, map.spatialReference));
        points.push(new esri.geometry.Point(extent.xmin, extent.ymin, map.spatialReference));
        points.push(new esri.geometry.Point(extent.xmin, extent.ymax, map.spatialReference));
        points.push(new esri.geometry.Point(extent.xmax, extent.ymax, map.spatialReference));
