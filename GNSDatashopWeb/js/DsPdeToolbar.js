...
var pdeToolbar = function (tbDefaultClass, tbDisabledClass, btnOutDefaultClass, btnInDefaultClass,
    ...
    this.PageLoad = function (divMapId, cmdZoomInId, cmdZoomOutId, cmdPanId, cmdPrevExtentid, cmdNextExtentId,
        ...
        allSelectableButtons = [cmdZoomIn, cmdZoomOut, cmdPan, cmdRectangle, cmdPolygon, cmdMove, cmdResize, cmdReshape];
    }
    ...
    */
    ...
    this.GetPolygonsJson = function () {
        ...
        // wia 2011/08/30 - check if at least one polygon exists
        if (map.graphics.graphics.length < 1) return null;

        // wia 2011/08/30 - disable edit or you get 9 points instead of 4, for example
        tbMap.DisableEdit();
